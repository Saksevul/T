void Analisis() {   Float_t PI=TMath::Pi(); Int_t nprint=1, evento=0;
  ...
  TFile* OutputFile = new TFile("/home/saksevul/T/OpenData/Jet_20000/ROOT6ak5PF-0001.root", "RECREATE");
  ...
  TH1F *h_ak5PFJets_pT04__Multiplicity  = new TH1F("ak5PFJets_pT>04__Multiplicidad", "Multiplicidad de ak5PFJets, con p_{T} > 04 GeV, por Evento; Numero de Jets; Ocurrencia", 120, 0, 120);
  TH1F *h_ak5PFJets_pT08__Multiplicity  = new TH1F("ak5PFJets_pT>08__Multiplicidad", "Multiplicidad de ak5PFJets, con p_{T} > 08 GeV, por Evento; Numero de Jets; Ocurrencia", 120, 0, 120);
  TH1F *h_ak5PFJets_pT16__Multiplicity  = new TH1F("ak5PFJets_pT>16__Multiplicidad", "Multiplicidad de ak5PFJets, con p_{T} > 16 GeV, por Evento; Numero de Jets; Ocurrencia", 120, 0, 120);
  TH1F *h_ak5PFJets_pT32__Multiplicity  = new TH1F("ak5PFJets_pT>32__Multiplicidad", "Multiplicidad de ak5PFJets, con p_{T} > 32 GeV, por Evento; Numero de Jets; Ocurrencia", 120, 0, 120);
  TH1F *h_ak5PFJets_pT64__Multiplicity  = new TH1F("ak5PFJets_pT>64__Multiplicidad", "Multiplicidad de ak5PFJets, con p_{T} > 64 GeV, por Evento; Numero de Jets; Ocurrencia", 120, 0, 120);
  // Espectro de p_T. Tomando como criterio de seleccion la multiplicidad de Jets en cada Evento.
  TH1F *h_ak5PFJets_Multiplicity64__pT = new TH1F("ak5PFJets_Mult<=64__pT", "Distribucion de pT de ak5PFJets, con Multilicidad <= 64, por Evento; p_{T} [GeV]; Ocurrencia", 800, 0, 3200);
  TH1F *h_ak5PFJets_Multiplicity32__pT = new TH1F("ak5PFJets_Mult<=32__pT", "Distribucion de pT de ak5PFJets, con Multilicidad <= 32, por Evento; p_{T} [GeV]; Ocurrencia", 800, 0, 3200);
  TH1F *h_ak5PFJets_Multiplicity16__pT = new TH1F("ak5PFJets_Mult<=16__pT", "Distribucion de pT de ak5PFJets, con Multilicidad <= 16, por Evento; p_{T} [GeV]; Ocurrencia", 800, 0, 3200);
  TH1F *h_ak5PFJets_Multiplicity08__pT = new TH1F("ak5PFJets_Mult<=08__pT", "Distribucion de pT de ak5PFJets, con Multilicidad <= 08, por Evento; p_{T} [GeV]; Ocurrencia", 800, 0, 3200);
  TH1F *h_ak5PFJets_Multiplicity04__pT = new TH1F("ak5PFJets_Mult<=04__pT", "Distribucion de pT de ak5PFJets, con Multilicidad <= 04, por Evento; p_{T} [GeV]; Ocurrencia", 800, 0, 3200);
  TH1F *h_ak5PFJets_Multiplicity02__pT = new TH1F("ak5PFJets_Mult<=02__pT", "Distribucion de pT de ak5PFJets, con Multilicidad <= 02, por Evento; p_{T} [GeV]; Ocurrencia", 800, 0, 3200);
  // Distancia angular entre Jets.
  TH1F *h_ak5PFJets__D__Jet_Jet      = new TH1F("ak5PFJets__D__Jet-Jet", "Distancia angular #sqrt{(#Delta#phi_{ij})^{2} + (#Delta#eta_{ij})^{2}} del ak5PFJet_{i} al ak5PFJet_{j}, por Evento; Valor; Ocurrencia", 120, 0, 12);
  TH1F *h_ak5PFJets_pT04__D__Jet_Jet = new TH1F("ak5PFJets_pT>04__D__Jet-Jet", "Distancia angular #sqrt{(#Delta#phi)^{2} + (#Delta#eta)^{2}} del ak5PFJet_{i} al ak5PFJet_{j}, por Evento; Valor; Ocurrencia", 120, 0, 12);
  TH1F *h_ak5PFJets_pT08__D__Jet_Jet = new TH1F("ak5PFJets_pT>08__D__Jet-Jet", "Distancia angular #sqrt{(#Delta#phi)^{2} + (#Delta#eta)^{2}} del ak5PFJet_{i} al ak5PFJet_{j}, por Evento; Valor; Ocurrencia", 120, 0, 12);
  TH1F *h_ak5PFJets_pT16__D__Jet_Jet = new TH1F("ak5PFJets_pT>16__D__Jet-Jet", "Distancia angular #sqrt{(#Delta#phi)^{2} + (#Delta#eta)^{2}} del ak5PFJet_{i} al ak5PFJet_{j}, por Evento; Valor; Ocurrencia", 120, 0, 12);
  TH1F *h_ak5PFJets_pT32__D__Jet_Jet = new TH1F("ak5PFJets_pT>32__D__Jet-Jet", "Distancia angular #sqrt{(#Delta#phi)^{2} + (#Delta#eta)^{2}} del ak5PFJet_{i} al ak5PFJet_{j}, por Evento; Valor; Ocurrencia", 120, 0, 12);
  TH1F *h_ak5PFJets_pT64__D__Jet_Jet = new TH1F("ak5PFJets_pT>64__D__Jet-Jet", "Distancia angular #sqrt{(#Delta#phi)^{2} + (#Delta#eta)^{2}} del ak5PFJet_{i} al ak5PFJet_{j}, por Evento; Valor; Ocurrencia", 120, 0, 12);
  // TH1F *h__eta_D__jet_jet   = new TH1F("ak5PFJets_distancia_eta  jet jet", "Distancia angular #eta entre todos los jets de cada evento; Distancia angular; Ocurrencia", 120, 0, 12);
  // TH1F *h__phi_D__jet_jet   = new TH1F("ak5PFJets_distancia_phi  jet jet", "Distancia angular #phi entre todos los jets de cada evento; Distancia angular; Ocurrencia", 63, 0, 6.3);
  ...
  // Electrones
  TH1F *h_gsfElectrons__Multiplicity        = new TH1F("gsfElectrones__Multiplicidad", "Multiplicidad, != 0, de gsfElectrones por Evento; Numero de electrones; Ocurrencia", 13, 0, 13);
  ...
  TH1F *h__pTQuotient_gsfElectron_ak5PFJet  = new TH1F("_Cociente_pT__gsfElectron-ak5PFJet",  "Cociente p_{T}  gsfElectron / ak5PFJet; Indice; Ocurrencia", 100, 0, 2);
  TH1F *h__pTQuotient_gsfElectron_ak5PFJet_Rmin= new TH1F("_Cociente_pT__gsfElectron-ak5PFJet R menor a 0.2",  "Cociente p_{T}  gsfElectron/ak5PFJet; Indice; Ocurrencia", 100, 0, 2);
  TH1F *h__pTQuotient_gsfElectron_ak5PFJet_Rmax= new TH1F("_Cociente_pT__gsfElectron-ak5PFJet R mayor a 0.2",  "Cociente p_{T}  gsfElectron/ak5PFJet; Indice; Ocurrencia", 100, 0, 2);
  TH1F *h__eta_D__gsfElectron_ak5PFJet = new TH1F("_D_eta__gsfElectron-ak5PFJet", "Diferencia |#eta_{gsfElectron} - #eta_{ak5PFJet}|; Distancia angular; Ocurrencia", 120, 0, 1.2);
  TH1F *h__phi_D__gsfElectron_ak5PFJet = new TH1F("_D_phi__gsfElectron-ak5PFJet", "Diferencia |#phi_{gsfElectron} - #phi_{ak5PFJet}|; Distancia angular; Ocurrencia", 120, 0, 1.2);
  TH1F *h__D__gsfElectron_ak5PFJet = new TH1F("_D__gsfElectron-ak5PFJet", "Distancia angular #sqrt{(#Delta#phi)^{2} + (#Delta#eta)^{2}} del gsfElectron al ak5PFJets; Valor; Ocurrencia", 120, 0, 1.2);
  // Fotones
  TH1F *h_Photons__Multiplicity         = new TH1F("Fotones__Multiplicidad", "Multiplicidad, != 0, de Fotones por Evento; Numero de fotones; Ocurrencia", 13, 0, 13);
  ...
  TH1F *h__pTQuotient_Photon_ak5PFJet   = new TH1F("Cociente_pT__Foton-ak5PFJet",  "Cociente p_{T}  Foton / ak5PFJets; Indice; Ocurrencia", 100, 0, 10);
  TH1F *h__eta_D__Photon_ak5PFJet  = new TH1F("_D_eta__Foton-ak5PFJet", "Diferencia |#eta_{Foton} - #eta_{ak5PFJet}|; Distancia angular; Ocurrencia", 120, 0, 1.2);
  TH1F *h__phi_D__Photon_ak5PFJet  = new TH1F("_D_phi__Foton-ak5PFJet", "Diferencia |#phi_{Foton} - #phi_{ak5PFJet}|; Distancia angular; Ocurrencia", 120, 0, 1.2);
  TH1F *h__D__Photon_ak5PFJet  = new TH1F("_D__Foton-ak5PFJet", "Distancia angular #sqrt{(#Delta#phi)^{2} + (#Delta#eta)^{2}} del Foton al ak5PFJets; Valor; Ocurrencia", 120, 0, 1.2);
  // Muones
  TH1F *h_Muons__Multiplicity         = new TH1F("Muones__Multiplicidad", "Multiplicidad, != 0, de Muones por Evento; Numero de muones; Ocurrencia", 13, 0, 13);
  ...
  TH1F *h__pTQuotient_Muon_ak5PFJet   = new TH1F("_Cociente_pT__Muon-ak5PFJet",  "Cociente p_{T}  Muon / ak5PFJets; Indice; Ocurrencia", 100, 0, 2);
  TH1F *h__eta_D__Muon_ak5PFJet  = new TH1F("_D_eta__Muon-ak5PFJet", "Diferencia |#eta_{Muon} - #eta_{ak5PFJet}|; Distancia angular; Ocurrencia", 120, 0, 1.2);
  TH1F *h__phi_D__Muon_ak5PFJet  = new TH1F("_D_phi__Muon-ak5PFJet", "Diferencia |#phi_{Muon} - #phi_{ak5PFJet}|; Distancia angular; Ocurrencia", 120, 0, 1.2);
  TH1F *h__D__Muon_ak5PFJet  = new TH1F("_D__Muon-ak5PFJet", "Distancia angular #sqrt{(#Delta#phi)^{2} + (#Delta#eta)^{2}} del Muon al ak5PFJets; Valor; Ocurrencia", 120, 0, 1.2);
  ...
  while (reader.Next()) {   Int_t MultJet_04=0, MultJet_08=0, MultJet_16=0, MultJet_32=0, MultJet_64=0;
    ...
    for (Int_t i=0; i<ak5PFJets_pt_.GetSize(); i++){
      ...
      for (Int_t j=i+1; j<ak5PFJets_pt_.GetSize(); j++) {
        // h__eta_D__jet_jet -> Fill( abs(ak5PFJets_eta_[i] - ak5PFJets_eta_[j]) );
        // h__phi_D__jet_jet -> Fill( abs(ak5PFJets_phi_[i] - ak5PFJets_phi_[j]) );
        if ( abs(ak5PFJets_phi_[i]-ak5PFJets_phi_[j]) <= PI ) {
          h_ak5PFJets__D__Jet_Jet    -> Fill( sqrt(pow(ak5PFJets_eta_[i]-ak5PFJets_eta_[j], 2) +  pow(ak5PFJets_phi_[i]-ak5PFJets_phi_[j], 2)) );
          if ( 4.0<ak5PFJets_pt_[i] &&  4.0<ak5PFJets_pt_[j])  h_ak5PFJets_pT04__D__Jet_Jet -> Fill( sqrt(pow(ak5PFJets_eta_[i]-ak5PFJets_eta_[j], 2) +  pow(ak5PFJets_phi_[i]-ak5PFJets_phi_[j], 2)) );
          if ( 8.0<ak5PFJets_pt_[i] &&  8.0<ak5PFJets_pt_[j])  h_ak5PFJets_pT08__D__Jet_Jet -> Fill( sqrt(pow(ak5PFJets_eta_[i]-ak5PFJets_eta_[j], 2) +  pow(ak5PFJets_phi_[i]-ak5PFJets_phi_[j], 2)) );
          if (16.0<ak5PFJets_pt_[i] && 16.0<ak5PFJets_pt_[j])  h_ak5PFJets_pT16__D__Jet_Jet -> Fill( sqrt(pow(ak5PFJets_eta_[i]-ak5PFJets_eta_[j], 2) +  pow(ak5PFJets_phi_[i]-ak5PFJets_phi_[j], 2)) );
          if (32.0<ak5PFJets_pt_[i] && 32.0<ak5PFJets_pt_[j])  h_ak5PFJets_pT32__D__Jet_Jet -> Fill( sqrt(pow(ak5PFJets_eta_[i]-ak5PFJets_eta_[j], 2) +  pow(ak5PFJets_phi_[i]-ak5PFJets_phi_[j], 2)) );
          if (64.0<ak5PFJets_pt_[i] && 64.0<ak5PFJets_pt_[j])  h_ak5PFJets_pT64__D__Jet_Jet -> Fill( sqrt(pow(ak5PFJets_eta_[i]-ak5PFJets_eta_[j], 2) +  pow(ak5PFJets_phi_[i]-ak5PFJets_phi_[j], 2)) );
        } else {  // Esto es debido a que ningún Jet puede estar a una distancia mayor a PI, de otro Jet.
          h_ak5PFJets__D__Jet_Jet    -> Fill( sqrt(pow(ak5PFJets_eta_[i]-ak5PFJets_eta_[j], 2) +  pow(2*PI-abs(ak5PFJets_phi_[i]-ak5PFJets_phi_[j]), 2)) );
          if ( 4.0<ak5PFJets_pt_[i] &&  4.0<ak5PFJets_pt_[j])  h_ak5PFJets_pT04__D__Jet_Jet -> Fill( sqrt(pow(ak5PFJets_eta_[i]-ak5PFJets_eta_[j], 2) +  pow(2*PI-abs(ak5PFJets_phi_[i]-ak5PFJets_phi_[j]), 2)) );
          if ( 8.0<ak5PFJets_pt_[i] &&  8.0<ak5PFJets_pt_[j])  h_ak5PFJets_pT08__D__Jet_Jet -> Fill( sqrt(pow(ak5PFJets_eta_[i]-ak5PFJets_eta_[j], 2) +  pow(2*PI-abs(ak5PFJets_phi_[i]-ak5PFJets_phi_[j]), 2)) );
          if (16.0<ak5PFJets_pt_[i] && 16.0<ak5PFJets_pt_[j])  h_ak5PFJets_pT16__D__Jet_Jet -> Fill( sqrt(pow(ak5PFJets_eta_[i]-ak5PFJets_eta_[j], 2) +  pow(2*PI-abs(ak5PFJets_phi_[i]-ak5PFJets_phi_[j]), 2)) );
          if (32.0<ak5PFJets_pt_[i] && 32.0<ak5PFJets_pt_[j])  h_ak5PFJets_pT32__D__Jet_Jet -> Fill( sqrt(pow(ak5PFJets_eta_[i]-ak5PFJets_eta_[j], 2) +  pow(2*PI-abs(ak5PFJets_phi_[i]-ak5PFJets_phi_[j]), 2)) );
          if (64.0<ak5PFJets_pt_[i] && 64.0<ak5PFJets_pt_[j])  h_ak5PFJets_pT64__D__Jet_Jet -> Fill( sqrt(pow(ak5PFJets_eta_[i]-ak5PFJets_eta_[j], 2) +  pow(2*PI-abs(ak5PFJets_phi_[i]-ak5PFJets_phi_[j]), 2)) );
        }
      }
      ...
      if (ak5PFJets_mElectronMultiplicity[i] == 1) {   Float_t etaD=10, phiD=PI; Int_t eta_j, phi_j; // Defino valores de referencia. Estos cambiarán más adelante.
        ...
        if (eta_j == phi_j) {       // Esto es para corroborar que el electrón más cercano en ETA es también el más cercano en PHI.
          ...
          h__eta_D__gsfElectron_ak5PFJet -> Fill(etaD);                 // Distancia en el ángulo ETA entre el jet y su electrón.
          h__phi_D__gsfElectron_ak5PFJet -> Fill(phiD);                 // Distancia en el ángulo PHI entre el jet y su electrón.
          h__D__gsfElectron_ak5PFJet -> Fill(sqrt(etaD*etaD + phiD*phiD)); // Distancia angular total entre el jet y su electrón.
      } }
      ...
      if (ak5PFJets_mPhotonMultiplicity[i] == 1) {   Float_t etaD=10, phiD=PI; Int_t eta_j, phi_j;
        ...
        if (eta_j == phi_j) {
          h__eta_D__Photon_ak5PFJet -> Fill(etaD);
          h__phi_D__Photon_ak5PFJet -> Fill(phiD);
          h__D__Photon_ak5PFJet -> Fill(sqrt(etaD*etaD + phiD*phiD));
      } }
      ...
      if (ak5PFJets_mMuonMultiplicity[i] == 1) {   Float_t etaD=10, phiD=PI; Int_t eta_j, phi_j;
        ...
        if (eta_j == phi_j) {
          ...
          h__eta_D__Muon_ak5PFJet -> Fill(etaD);
          h__phi_D__Muon_ak5PFJet -> Fill(phiD);
          h__D__Muon_ak5PFJet -> Fill(sqrt(etaD*etaD + phiD*phiD));
      } }
  ...
  // h_ak5PFJets__D__Jet_Jet    -> Scale(1.0/h_ak5PFJets__D__Jet_Jet   ->Integral());
  ...
  // h__eta_D__jet_jet   -> Write();
  // h__phi_D__jet_jet   -> Write();
